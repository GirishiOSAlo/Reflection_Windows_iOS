...
@IBDesignable open class DPOTPView: UIView {
    ...
    @IBInspectable open dynamic var count: Int = 6 {
        didSet {
            if isLoaded {
                isLoaded = false
    ...
    @IBInspectable open dynamic var spacing: CGFloat = 6
    ...
    @IBInspectable open dynamic var fontTextField: UIFont = UIFont.systemFont(ofSize: 12)
...
extension DPOTPView : UITextFieldDelegate , OTPBackTextFieldDelegate {
    ...
    public func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        //Enter Only Number Digit, Not a Other Character...
